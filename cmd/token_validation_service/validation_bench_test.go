...
func CreateViewsWithProofs(b *testing.B, testRoot string, f *TokenValidationServiceViewFactory, n int) (*viewPool, []*transferServiceParams) {
	b.Helper()
	vp := &viewPool{}

	ps, err := NewTokenValidationParamsSlice(testRoot)
