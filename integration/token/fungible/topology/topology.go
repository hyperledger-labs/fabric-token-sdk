...
func Topology(opts common.Opts) []api.Topology {
	...
	issuer.RegisterResponder(&views.IssuerRedeemAcceptView{}, &views.RedeemView{})
	...
	issuer.RegisterViewFactory("SetBinding", &views.SetBindingViewFactory{})

	//newIssuer := fscTopology.AddNodeByName("newIssuer").AddOptions(  // TODO: Uncomment
	//	fabric.WithOrganization("Org1"),
	//	fabric.WithAnonymousIdentity(),
	//	orion.WithRole("issuer"),
	//	token.WithDefaultIssuerIdentity(opts.HSM),
	...
	auditor.RegisterViewFactory("SetBinding", &views.SetBindingViewFactory{})
	//}
	...
	alice.RegisterViewFactory("SetBinding", &views.SetBindingViewFactory{})

	//bob := fscTopology.AddNodeByName("bob").AddOptions( // TODO: uncomment
	//	fabric.WithOrganization("Org2"),
	//	fabric.WithAnonymousIdentity(),
	//	orion.WithRole("bob"),
	//	token.WithDefaultOwnerIdentity(),
