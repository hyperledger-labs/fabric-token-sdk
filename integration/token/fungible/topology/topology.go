...
func Topology(opts common.Opts) []api.Topology {
	...
	alice.RegisterResponder(&views.MultiSigAcceptSpendView{}, &views.MultiSigSpendView{})
	...
	bob.RegisterResponder(&views.MultiSigAcceptSpendView{}, &views.MultiSigSpendView{})
	...
	charlie.RegisterResponder(&views.MultiSigAcceptSpendView{}, &views.MultiSigSpendView{})
	...
	manager.RegisterResponder(&views.MultiSigAcceptSpendView{}, &views.MultiSigSpendView{})
