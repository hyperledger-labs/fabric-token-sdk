...
type RecipientExtractor interface {
	Recipients(ctx context.Context, id driver.Identity) ([]driver.Identity, error)
}
...
func (d *Deserializer) Recipients(ctx context.Context, id driver.Identity) ([]driver.Identity, error) {
	return d.recipientExtractor.Recipients(ctx, id)
}
