...
//go:embed testdata testdata2
var testDataFS embed.FS

// TestRegression runs previously recorded regression test vectors contained in the
// `testdata/<variant>` and `testdata2/<variant>` directories. Each directory contains a `params.txt` and a
...
//
// Notes:
//   - The testdata used here is generated by `testdata/generator` or `testdata2/generator`. If you need to
//     re-generate vectors for a new setup, run that generator and commit the
//     produced artifacts to the corresponding `testdata/...` or `testdata2/...` directory.
...
func TestRegression(t *testing.T) {
	t.Parallel()
	for _, root := range []string{"testdata", "testdata2"} {
