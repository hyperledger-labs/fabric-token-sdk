...
type Deserializer struct {
	...
	RecipientsStub        func(context.Context, driver.Identity) ([]driver.Identity, error)
...
func (fake *Deserializer) GetAuditorVerifier(arg1 context.Context, arg2 driver.Identity) (driver.Verifier, error) {
	...
	fake.recordInvocation("GetAuditorVerifier", []interface{}{arg1, arg2})
...
func (fake *Deserializer) GetIssuerVerifier(arg1 context.Context, arg2 driver.Identity) (driver.Verifier, error) {
	...
	fake.recordInvocation("GetIssuerVerifier", []interface{}{arg1, arg2})
...
func (fake *Deserializer) Recipients(arg1 context.Context, arg2 driver.Identity) ([]driver.Identity, error) {
	...
	fake.recordInvocation("Recipients", []interface{}{arg1, arg2})
...
func (fake *Deserializer) RecipientsCalls(stub func(context.Context, driver.Identity) ([]driver.Identity, error)) {
	fake.recipientsMutex.Lock()
	defer fake.recipientsMutex.Unlock()
	fake.RecipientsStub = stub
}

func (fake *Deserializer) RecipientsArgsForCall(i int) (context.Context, driver.Identity) {
	fake.recipientsMutex.RLock()
	defer fake.recipientsMutex.RUnlock()
