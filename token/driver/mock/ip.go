...
func (fake *IdentityProvider) GetEIDAndRH(arg1 context.Context, arg2 driver.Identity, arg3 []byte) (string, string, error) {
	...
	fake.recordInvocation("GetEIDAndRH", []interface{}{arg2, arg3Copy})
...
func (fake *IdentityProvider) GetEIDAndRHReturns(ctx context.Context, result1 string, result2 string, result3 error) {
	fake.getEIDAndRHMutex.Lock()
	defer fake.getEIDAndRHMutex.Unlock()
...
func (fake *IdentityProvider) RegisterRecipientIdentity(arg1 context.Context, arg2 driver.Identity) error {
	...
	fake.recordInvocation("RegisterRecipientIdentity", []interface{}{arg2})
