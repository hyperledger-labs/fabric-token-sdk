...
func (fake *TokenVault) UnspentTokensIteratorBy(arg1 context.Context, arg2 string, arg3 token.Type, arg4 int) (driver.UnspentTokensIterator, error) {
...
func (fake *TokenVault) UnspentTokensIteratorByCalls(stub func(context.Context, string, token.Type, int) (driver.UnspentTokensIterator, error)) {
	fake.unspentTokensIteratorByMutex.Lock()
	defer fake.unspentTokensIteratorByMutex.Unlock()
	fake.UnspentTokensIteratorByStub = stub
}

func (fake *TokenVault) UnspentTokensIteratorByArgsForCall(i int) (context.Context, string, token.Type, int) {
	fake.unspentTokensIteratorByMutex.RLock()
	defer fake.unspentTokensIteratorByMutex.RUnlock()
