...
func (fake *TokenManagerServiceProvider) recordInvocation(key string, args []interface{}) {
...
var _ driver.TokenManagerServiceProvider = new(TokenManagerServiceProvider)
