...
type TransferService interface {
	...
	Transfer(ctx context.Context, txID string, wallet OwnerWallet, ids []*token2.ID, Outputs []*token2.Token, issuerPublicKey []byte, opts *TransferOptions) (TransferAction, *TransferMetadata, error)
