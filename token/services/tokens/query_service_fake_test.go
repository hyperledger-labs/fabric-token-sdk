...
func (fake *FakeQueryService) IsMine(arg1 context.Context, arg2 *token.ID) (bool, error) {
...
func (fake *FakeQueryService) IsMineCalls(stub func(context.Context, *token.ID) (bool, error)) {
	fake.isMineMutex.Lock()
	defer fake.isMineMutex.Unlock()
	fake.IsMineStub = stub
}

func (fake *FakeQueryService) IsMineArgsForCall(i int) (context.Context, *token.ID) {
	fake.isMineMutex.RLock()
	defer fake.isMineMutex.RUnlock()
...
var _ tokens.QueryService = new(FakeQueryService)
