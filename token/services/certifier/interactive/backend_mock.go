...
type BackendMock struct {
	LoadStub        func(view.Context, *CertificationRequest) ([][]byte, error)
	loadMutex       sync.RWMutex
	loadArgsForCall []struct {
		arg1 view.Context
		arg2 *CertificationRequest
	}
	loadReturns struct {
		result1 [][]byte
		result2 error
...
func (fake *BackendMock) Load(arg1 view.Context, arg2 *CertificationRequest) ([][]byte, error) {
	fake.loadMutex.Lock()
...
func (fake *BackendMock) LoadCalls(stub func(view.Context, *CertificationRequest) ([][]byte, error)) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = stub
}

func (fake *BackendMock) LoadArgsForCall(i int) (view.Context, *CertificationRequest) {
	fake.loadMutex.RLock()
	defer fake.loadMutex.RUnlock()
