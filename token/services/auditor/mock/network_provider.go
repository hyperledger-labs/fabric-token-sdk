...
func (fake *NetworkProvider) GetNetwork(arg1 string, arg2 string) (*network.Network, error) {
...
func (fake *NetworkProvider) GetNetworkCalls(stub func(string, string) (*network.Network, error)) {
	fake.getNetworkMutex.Lock()
...
func (fake *NetworkProvider) GetNetworkReturns(result1 *network.Network, result2 error) {
	fake.getNetworkMutex.Lock()
	defer fake.getNetworkMutex.Unlock()
...
func (fake *NetworkProvider) GetNetworkReturnsOnCall(i int, result1 *network.Network, result2 error) {
	fake.getNetworkMutex.Lock()
	defer fake.getNetworkMutex.Unlock()
	fake.GetNetworkStub = nil
...
var _ auditor.NetworkProvider = new(NetworkProvider)
