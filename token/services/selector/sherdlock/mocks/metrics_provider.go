...
func (fake *FakeProvider) NewCounter(arg1 metricsa.CounterOpts) metricsa.Counter {
...
func (fake *FakeProvider) NewCounterCalls(stub func(metricsa.CounterOpts) metricsa.Counter) {
	fake.newCounterMutex.Lock()
	defer fake.newCounterMutex.Unlock()
	fake.NewCounterStub = stub
}

func (fake *FakeProvider) NewCounterArgsForCall(i int) metricsa.CounterOpts {
	fake.newCounterMutex.RLock()
	defer fake.newCounterMutex.RUnlock()
...
func (fake *FakeProvider) NewCounterReturns(result1 metricsa.Counter) {
	fake.newCounterMutex.Lock()
	defer fake.newCounterMutex.Unlock()
...
func (fake *FakeProvider) NewCounterReturnsOnCall(i int, result1 metricsa.Counter) {
	fake.newCounterMutex.Lock()
	defer fake.newCounterMutex.Unlock()
	fake.NewCounterStub = nil
...
func (fake *FakeProvider) NewGauge(arg1 metricsa.GaugeOpts) metricsa.Gauge {
...
func (fake *FakeProvider) NewGaugeCalls(stub func(metricsa.GaugeOpts) metricsa.Gauge) {
	fake.newGaugeMutex.Lock()
	defer fake.newGaugeMutex.Unlock()
	fake.NewGaugeStub = stub
}

func (fake *FakeProvider) NewGaugeArgsForCall(i int) metricsa.GaugeOpts {
	fake.newGaugeMutex.RLock()
	defer fake.newGaugeMutex.RUnlock()
...
func (fake *FakeProvider) NewGaugeReturns(result1 metricsa.Gauge) {
	fake.newGaugeMutex.Lock()
	defer fake.newGaugeMutex.Unlock()
...
func (fake *FakeProvider) NewGaugeReturnsOnCall(i int, result1 metricsa.Gauge) {
	fake.newGaugeMutex.Lock()
	defer fake.newGaugeMutex.Unlock()
	fake.NewGaugeStub = nil
...
func (fake *FakeProvider) NewHistogram(arg1 metricsa.HistogramOpts) metricsa.Histogram {
...
func (fake *FakeProvider) NewHistogramCalls(stub func(metricsa.HistogramOpts) metricsa.Histogram) {
	fake.newHistogramMutex.Lock()
	defer fake.newHistogramMutex.Unlock()
	fake.NewHistogramStub = stub
}

func (fake *FakeProvider) NewHistogramArgsForCall(i int) metricsa.HistogramOpts {
	fake.newHistogramMutex.RLock()
	defer fake.newHistogramMutex.RUnlock()
...
func (fake *FakeProvider) NewHistogramReturns(result1 metricsa.Histogram) {
	fake.newHistogramMutex.Lock()
	defer fake.newHistogramMutex.Unlock()
...
func (fake *FakeProvider) NewHistogramReturnsOnCall(i int, result1 metricsa.Histogram) {
	fake.newHistogramMutex.Lock()
	defer fake.newHistogramMutex.Unlock()
	fake.NewHistogramStub = nil
