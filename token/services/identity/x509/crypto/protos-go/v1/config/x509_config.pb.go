...
const file_x509_config_proto_rawDesc = "" +
	...
	"\fCryptoConfig\x122\n" +
	"\x15signature_hash_family\x18\x01 \x01(\tR\x13signatureHashFamily\"\x8d\x01\n" +
	"\x13SigningIdentityInfo\x12#\n" +
	"\rpublic_signer\x18\x01 \x01(\fR\fpublicSigner\x12Q\n" +
	...
	"\fkey_material\x18\x02 \x01(\fR\vkeyMaterialBfZdgithub.com/LFDT-Panurus/panurus/token/services/identity/x509/crypto/protos-go/v1/configb\x06proto3"
...
var file_x509_config_proto_goTypes = []any{
	(*Config)(nil),              // 0: fabric_token_sdk.identity.x509.v1.Config
	(*CryptoConfig)(nil),        // 1: fabric_token_sdk.identity.x509.v1.CryptoConfig
	(*SigningIdentityInfo)(nil), // 2: fabric_token_sdk.identity.x509.v1.SigningIdentityInfo
	(*KeyInfo)(nil),             // 3: fabric_token_sdk.identity.x509.v1.KeyInfo
}
var file_x509_config_proto_depIdxs = []int32{
	2, // 0: fabric_token_sdk.identity.x509.v1.Config.signing_identity:type_name -> fabric_token_sdk.identity.x509.v1.SigningIdentityInfo
	1, // 1: fabric_token_sdk.identity.x509.v1.Config.crypto_config:type_name -> fabric_token_sdk.identity.x509.v1.CryptoConfig
	3, // 2: fabric_token_sdk.identity.x509.v1.SigningIdentityInfo.private_signer:type_name -> fabric_token_sdk.identity.x509.v1.KeyInfo
