...
func NewMSPConfigFromURL(issuerPublicKey []byte, dir string, id string, ignoreVerifyOnlyWallet bool) (*Config, error) {
...
func GetIdemixMspConfigWithType(issuerPublicKey []byte, dir string, ID string, ignoreVerifyOnlyWallet bool) (*Config, error) {
...
func GetFabricCAIdemixMspConfig(issuerPublicKey []byte, dir string, ID string) (*Config, error) {
	var signer *idemixmsp.IdemixMSPSignerConfig
...
func NewMSPConfigFromRawSigner(issuerPublicKey []byte, signerRaw []byte, ID string) (*Config, error) {
	var signer *idemixmsp.IdemixMSPSignerConfig
	if len(signerRaw) != 0 {
		signer = &idemixmsp.IdemixMSPSignerConfig{}
	...
	return &Config{Config: confBytes, Type: int32(idemix.IDEMIX)}, nil
}

func NewMSPConfig(issuerPublicKey []byte, signer *idemixmsp.IdemixMSPSignerConfig, ID string) (*Config, error) {
	idemixConfig := &idemixmsp.IdemixMSPConfig{
		Name:   ID,
		Ipk:    issuerPublicKey,
		Signer: signer,
