...
func NewRole(ctx context.Context, logger logging.Logger, roleID identity.RoleType, networkID string, nodeIdentity driver.Identity, localMembership localMembership) *Role {
	return &Role{
		logger:          logger,
		roleID:          roleID,
		networkID:       networkID,
