...
func (t *TypedIdentityDeserializer) Recipients(ctx context.Context, id driver.Identity, typ identity.Type, raw []byte) ([]driver.Identity, error) {
	if typ != htlc.ScriptType {
...
func (a *AuditDeserializer) DeserializeAuditInfo(ctx context.Context, bytes []byte) (driver2.AuditInfo, error) {
	si := &ScriptInfo{}
