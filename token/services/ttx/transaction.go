...
func (t *Transaction) Redeem(wallet *token.OwnerWallet, typ token2.Type, value uint64, issuerPublicKey []byte, opts ...token.TransferOption) error {
	return t.TokenRequest.Redeem(t.Context, wallet, typ, value, issuerPublicKey, opts...)
}
